...
class TcurController extends BackendController {
    ...
    protected function before_filter() {
        ...
        $this->page_title = 'Territorios Urbanos';
    }
    ...
    public function index() {
        Redirect::toAction('listar_territorio_ur');
    }
    ...
    public function listar_territorio_ur($order='order.territorio.asc', $page='page.1') { 
        ...
        $this->order = $order;      
        $this->page = $page;
        Session::set('redir_back', 'violencia_politica/tcur/listar_territorio_ur/'.$order.'/'.$page.'/');
    ...
    public function listar_caso($territorio_id, $territorio_nombre) { 
        ...
        $this->page_module = 'Violencia Política';
        //Session::set('redir_back', 'violencia_politica/tcur/listar_caso/'.$territorio_id.'/'.$territorio_nombre.'/');
    }   
     ...
     */
    public function buscar_territorio_ur($field='nombre del terriotorio', $value='none', $order='order.id.asc', $page='page.1') {        
        $page       = (Filter::get($page, 'page') > 0) ? Filter::get($page, 'page') : 1;
        ...
        $this->value        = $value;  
        $this->page         = $page;
        Session::set('redir_back', 'violencia_politica/tcur/buscar_territorio_ur/'.$field.'/'.$value.'/'.$order.'/'.$page.'/');
    }

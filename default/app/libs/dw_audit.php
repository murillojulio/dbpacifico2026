...
class DwAudit extends Logger {
    ...
    public static function create ($msg, $name_log='') {
        ...
        $body.= "<b>Fecha:</b>&nbsp;&nbsp;&nbsp;&nbsp;".date("d-m-Y")."<br>";
        $body.= "<b>Hora:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".date("h:i:sa")."<br><br>";
        $body.= "<b>Acción:</b>&nbsp;&nbsp;".$msg;
        /*CorreoAlert::send_alert(Usuario::usuariosAlertar(), 
                                "Nuevo Registro - ".Session::get('login')." ".date("d-m-Y")."~".date("h:i:sa"), $body);*/
    }
    
    
    /**
     * Genera un log de tipo EDIT
     *
     * @return
     * @param string $msg
     * @param string $name_log
